"""Dispatch endpoints — add these to rain_backend.py (or import this module).

Adds:
  POST /dispatch          → route a task through the dispatcher
  GET  /dispatch/status   → which adapters are live
"""
...
# ── Registration snippet (add to rain_backend.py) ──────────────────
